    ...
    return (
        ...
        <div className="container"> 
          <div className="navbar-header">
            ...
            <a className="navbar-brand page-scroll" href="#page-top">Company Name</a> </div>
          
          <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul className="nav navbar-nav navbar-right">
              <li><a href="#features" className="page-scroll">Why Our Company?</a></li>
              <li><a href="#about" className="page-scroll">About</a></li>
              <li><a href="#services" className="page-scroll">Products</a></li>
              <li><a href="#portfolio" className="page-scroll">Pricing</a></li>
